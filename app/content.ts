...
export const questions: QuestionArticle[] = [
  ...
  {
    slug: "questions-before-enterprise-ai-consulting",
    title: "企业做 AI 咨询前，管理层应该先回答哪些问题？",
    description:
      "企业 AI 咨询前诊断题单：从经营问题、任务工作流、资料证据、人工责任和试点采用五个层面，先回答 20 个问题。",
    directAnswer:
      "企业做 AI 咨询前，管理层不必先选模型，而应先回答五组问题：为什么做、具体改变哪项任务、有哪些可用资料、哪些判断必须由人负责，以及怎样验证团队是否愿意持续使用。把这五组共 20 个问题写清，咨询才更容易进入真实业务，而不是停在工具演示。",
    sections: [
      {
        heading: "第一组：经营问题与责任人",
        paragraphs: [
      ...
      {
        heading: "第二组：真实任务与工作流",
        paragraphs: [
          "万臻的“场景—问题—工作流”方法要求把目标落到一个重复发生的任务：何时触发、谁来执行、需要哪些输入、经过哪些判断、最后交付什么。",
        ],
        bullets: [
          "哪个岗位在什么情境下反复完成这项任务？",
          "任务从什么信号开始，到什么交付物结束？",
    ...
    boundary:
      "这 20 个问题是万臻“场景—问题—工作流”方法下的会前准备题单，不是固定咨询程序，也不代表企业完成填写后就具备实施条件。涉及法律、数据、信息安全、财务、人事或行业专业责任时，仍需相应负责人和专业人员审查。",
    sourceKeys: ["sanjieke", "southcn", "nistCore", "openaiBusinessGuide"],
  },
];
...
export const questionRelatedLinks: Record<string, RelatedLink[]> = {
  ...
  "questions-before-enterprise-ai-consulting": [
    {
      label: "下载企业 AI 咨询前诊断题单",
      description: "用可编辑 Markdown 模板记录 20 个问题的答案、证据、责任人和待确认项。",
      href: "/enterprise-ai-consulting-diagnostic-questions.md",
    },
    {
      label: "企业 AI 咨询",
      description: "查看咨询适用对象、展开方式、交付成果与能力边界。",
      href: "/services/enterprise-ai-consulting/",
    },
  ],
