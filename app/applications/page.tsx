...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const description =
    "销售、客户服务、采购、知识管理和经营管理五类企业 AI 咨询与培训工作流：适用条件、必要输入、操作步骤、人工复核、产出与试点边界。";
  return {
    title,
    description,
      ...
      <main id="main-content" className="page">
        <header className="hub-hero">
          ...
          <p className="hub-answer">
            五类业务工作流都从真实输入开始，明确 AI 处理、人工判断、交付物和异常边界。每页同时说明什么时候先做咨询、什么时候进入培训、什么时候适合小范围试点；它们不是未经证实的客户成效案例。
          </p>
        </header>
